...
def homepage():
    ...
    paragraph2 = "This project was inspired by Rob Dunn Lap." 
    paragraph3 ="The mission of this project was to investigate the microbes inhabiting in our navels."
    paragraph4 = "Below is an interactive dashboard displaying some the results."
    paragraph = paragraph2 + " " +paragraph3 +" " + paragraph4
